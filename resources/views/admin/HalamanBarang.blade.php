...
<head>
    ...
    .card-img-top {
        ...
        /* Lebar gambar card */
        height: 100%;
        /* Tinggi gambar mengikuti tinggi card */
        object-fit: contain;
        /* Menjaga gambar tidak terpotong */
        background-color: #f8f9fa;
        /* Warna latar belakang jika gambar tidak mengisi seluruh area */
    }
...
<body class="bg-gray-200">
    ...
    <nav class="navbar navbar-expand-lg navbar-custom bg-gray-200 border-b border-gray-300 sticky top-0 z-50">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            <!-- Logo -->
            <a class="navbar-brand mb-2" href="#"><img src="{{ asset('img/DatakuLogo.png') }}" alt="Logo"
                    width="220px"></a>

            <!-- Button Tambah -->
            <div>
                <button
                    class="btn text-white bg-blue-800 hover:bg-green-800 px-3 py-1 rounded-md items-center justify-center ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex align-items-center ms-auto">
                    <form class="d-flex" role="search" method="GET" action="{{ route('admin.search') }}">
                        <input class="form-control px-3 py-1 me-3" type="search" name="search"
                            placeholder="Cari data barang disini" aria-label="Search">
                        <button type="submit"
                            class="btn text-white bg-blue-900 hover:bg-blue-500 px-2 py-1 rounded">Search</button>
                    </form>

                    <!-- Dropdown for Actions -->
                    <div class="nav-item dropdown ms-4">
                        <!-- Reduced margin to move it closer to the search button -->
                        <div class="nav-link dropdown-toggle px-3 py-1 rounded-md text-gray-600 bg-white border border-gray-200"
                            id="actionsDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Action
                        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6  d-flex justify-content-center mt-2">
                <div class="card">
                    <img src="{{ asset($data->gambar ? 'images/' . $data->gambar : 'images/default.png') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.edit', $data->id) }}"
                                class="btn text-white bg-blue-900 hover:bg-yellow-400">Edit</a>
                            <form action="{{ route('admin.delete', $data->id) }}" method="post" class="d-inline"
